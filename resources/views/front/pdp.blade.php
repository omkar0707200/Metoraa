            ...
            <div class="row">
                ...
                <div class="col-lg-6 product-images">
                    <div class="main-image">
                        <img src="https://images.unsplash.com/photo-1556911220-bff31c812dba?w=800" 
                             alt="Premium Kitchen Cabinet" 
                             id="mainImage">
                    </div>
                    <div class="thumbnail-images">
                        <div class="thumbnail active" onclick="changeImage('https://images.unsplash.com/photo-1556911220-bff31c812dba?w=800')">
                            <img src="https://images.unsplash.com/photo-1556911220-bff31c812dba?w=200" alt="View 1">
                        </div>
                        <div class="thumbnail" onclick="changeImage('https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800')">
                            <img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200" alt="View 2">
                        </div>
                ...
                <div class="col-lg-6 product-info">
                    ...
                    <h1 class="product-title">Premium Modular Kitchen Cabinet Set</h1>
                    ...
                    <div class="product-price">
                        <span class="sale-price">₹89,999</span>
                        <span class="original-price">₹1,24,999</span>
                        <span class="discount-badge">28% OFF</span>
                    </div>

                    <div class="product-description">
                        <p>Transform your kitchen with our premium modular cabinet set. Crafted with excellence, featuring durable materials, modern design, and ample storage space. Perfect for contemporary homes seeking functionality and elegance.</p>
                    </div>
